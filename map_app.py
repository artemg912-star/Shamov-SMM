...
<style>
    ...
    /* 🌟 CONSTRAIN CONTAINER TO 1200PX AND CENTER IT 🌟 */
    .block-container {
    ...
    /* Interactive Button Styles (Solid Red #EF4444, no shadows, 6px radius, hover highlights) */
    .stButton>button {
    ...
    .stButton>button:hover {
        background-color: #F87171 !important; /* Lighter red on hover */
...
# Floating panel containing the slider AND the popover button in columns! (NO DUPLICATE TABS!)
col_f_slider, col_f_btn = st.columns([3, 1])

with col_f_slider:
    min_rating = st.slider("⭐ Минимальная оценка асфальта (Оценка: 1/5 - 5/5):", 1, 5, 3)

with col_f_btn:
    st.write("") # Tiny spacer to perfectly align button with slider
...
# ---------------------------------------------------------
# 3. COMPACT LOWER CARD (Zero-Scroll Column-Free on bottom)
# ---------------------------------------------------------
st.write("")
...
<p style="color: #EF4444; font-size: 0.9rem; margin: 0; font-family: sans-serif;"><i class="fa-solid fa-circle-info"></i> {wheel_recommendation}</p>
</div>
...
<div class="mobile-partner-container" style="display: flex; justify-content: space-between; align-items: center; gap: 12px; margin-top: 12px;">
    <div style="display: flex; align-items: center; gap: 8px;">
        <span style="color: #94A3B8; font-size: 0.8rem; font-weight: 700; font-family: sans-serif; text-transform: uppercase; letter-spacing: 0.08em;"><i class="fa-solid fa-handshake" style="color: #EF4444; margin-right: 4px;"></i> Официальный партнёр</span>
    </div>
